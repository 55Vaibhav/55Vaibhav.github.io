...
const Skills = () => {
  return (
    <section id='skills'>
        ...
        <span className='skillDesc'>Recent graduate with a good command of Java, C, C#, MySQL, Website Designing and Development. Excited to apply my technical skills in a dynamic environment, contribute to impactful projects, and continue learning and growing.</span>
